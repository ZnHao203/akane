...
while (current < data_len):
    ...
    delta_x = fish_data_2["xmax"] - fish_data_1["xmax"] + fish_data_2["xmin"] - fish_data_1["xmin"]
    delta_y = fish_data_2["ymax"] - fish_data_1["ymax"] + fish_data_2["ymin"] - fish_data_1["ymin"]
    # print debug
